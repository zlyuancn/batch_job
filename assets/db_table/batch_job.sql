...
(
    ...
    `processorCarryJobData` tinyint unsigned   NOT NULL DEFAULT 0 COMMENT '处理回调是否携带任务数据jobData 0=否 1=是',
    PRIMARY KEY (`id`),
    UNIQUE KEY (`job_id`),
...
(
    ...
    KEY `batch_job_log_data_id` (`job_id`, `data_index`, `create_time` DESC)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
