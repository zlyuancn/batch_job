...
(
    ...
    `cb_process_finish`         varchar(256)       NOT NULL DEFAULT '' COMMENT '处理任务完成回调. 用于业务方做一些清理. 选填',
    ...
    `cb_process_finish_timeout` int unsigned       NOT NULL DEFAULT 30 COMMENT '处理任务完成回调超时秒数',
