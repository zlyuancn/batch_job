...
const (
	RateType_RateSec       RateType = 0 // 标准限速
	RateType_Serialization RateType = 1 // 串行化限速
)
...
type AdminRegistryBizReq struct {
	...
	ExecType              ExecType `protobuf:"varint,4,opt,name=exec_type,json=execType,proto3,enum=batch_job.ExecType" json:"exec_type,omitempty"`                    // 执行类型
	CbBeforeCreate        string   `protobuf:"bytes,5,opt,name=cb_before_create,json=cbBeforeCreate,proto3" json:"cb_before_create,omitempty"`                         // 创建任务回调url
	CbBeforeRun           string   `protobuf:"bytes,6,opt,name=cb_before_run,json=cbBeforeRun,proto3" json:"cb_before_run,omitempty"`                                  // 启动前回调. 一旦配置, 则任务必须由业务主动调用 BizStartJob 执行任务. 否则任务将一直处于 JobStatus.WaitBizRun 状态
	CbProcess             string   `protobuf:"bytes,7,opt,name=cb_process,json=cbProcess,proto3" json:"cb_process,omitempty"`                                          // 处理任务回调. 必填
	CbProcessStop         string   `protobuf:"bytes,8,opt,name=cb_process_stop,json=cbProcessStop,proto3" json:"cb_process_stop,omitempty"`                            // 任务停止回调. 用于业务方做一些清理. 选填
	CbBeforeCreateTimeout int32    `protobuf:"varint,9,opt,name=cb_before_create_timeout,json=cbBeforeCreateTimeout,proto3" json:"cb_before_create_timeout,omitempty"` // 启动前回调超时秒数
	CbBeforeRunTimeout    int32    `protobuf:"varint,10,opt,name=cb_before_run_timeout,json=cbBeforeRunTimeout,proto3" json:"cb_before_run_timeout,omitempty"`         // 启动前回调超时秒数
	CbProcessTimeout      int32    `protobuf:"varint,11,opt,name=cb_process_timeout,json=cbProcessTimeout,proto3" json:"cb_process_timeout,omitempty"`                 // 处理任务回调超时秒数
	CbProcessStopTimeout  int32    `protobuf:"varint,12,opt,name=cb_process_stop_timeout,json=cbProcessStopTimeout,proto3" json:"cb_process_stop_timeout,omitempty"`   // 处理任务停止回调超时秒数
	...
	RateSec               int32    `protobuf:"varint,14,opt,name=rate_sec,json=rateSec,proto3" json:"rate_sec,omitempty"`                                              // 每秒处理速率. 0表示不限制
}
...
var file_batch_job_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xaf, 0x05, 0x0a, 0x13, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x67,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x73, 0x44, 0x61, 0x74, 0x61, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x23, 0x0a, 0x0d,
	0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0c, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x4e, 0x75,
	0x6d, 0x12, 0x1e, 0x0a, 0x0b, 0x65, 0x72, 0x72, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x6e, 0x75, 0x6d,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x65, 0x72, 0x72, 0x4c, 0x6f, 0x67, 0x4e, 0x75,
	...
	0x12, 0x22, 0x0a, 0x02, 0x6f, 0x70, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x62,
	0x61, 0x74, 0x63, 0x68, 0x5f, 0x6a, 0x6f, 0x62, 0x2e, 0x4f, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x41,
	0x52, 0x02, 0x6f, 0x70, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x86, 0x01, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x6f,
	0x67, 0x51, 0x12, 0x17, 0x0a, 0x07, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0
 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x12, 0x1e, 0x0a, 0x06, 0x6a, 0x6f, 0x62,
	...
	,
...
var file_batch_job_proto_depIdxs = []int32{
	1,  // 0: batch_job.AdminRegistryBizReq.exec_type:type_name -> batch_job.ExecType
	0,  // 1: batch_job.AdminRegistryBizReq.rate_type:type_name -> batch_job.RateType
	...
	4,  // 19: batch_job.BatchJobService.AdminChangeBiz:input_type -> batch_job.AdminRegistryBizReq
	12, // 20: batch_job.BatchJobService.AdminCreateJob:input_type -> batch_job.AdminCreateJobReq
	14, // 21: batch_job.BatchJobService.AdminStartJob:input_type -> batch_job.AdminStartJobReq
	16, // 22: batch_job.BatchJobService.AdminStopJob:input_type -> batch_job.AdminStopJobReq
	18, // 23: batch_job.BatchJobService.QueryBizInfo:input_type -> batch_job.QueryBizInfoReq
	20, // 24: batch_job.BatchJobService.QueryBizList:input_type -> batch_job.QueryBizListReq
	22, // 25: batch_job.BatchJobService.QueryJobBaseInfo:input_type -> batch_job.QueryJobBaseInfoReq
	24, // 26: batch_job.BatchJobService.QueryJobList:input_type -> batch_job.QueryJobListReq
	26, // 27: batch_job.BatchJobService.QueryJobDataLog:input_type -> batch_job.QueryJobDataLogReq
	28, // 28: batch_job.BatchJobService.BizStartJob:input_type -> batch_job.BizStartJobReq
	30, // 29: batch_job.BatchJobService.BizStopJob:input_type -> batch_job.BizStopJobReq
	32, // 30: batch_job.BatchJobService.BizUpdateBizData:input_type -> batch_job.BizUpdateBizDataReq
	34, // 31: batch_job.BatchJobService.BizIncrProcessedNum:input_type -> batch_job.BizIncrProcessedNumReq
	36, // 32: batch_job.BatchJobService.BizAddDataLog:input_type -> batch_job.BizAddDataLogReq
	5,  // 33: batch_job.BatchJobService.AdminRegistryBiz:output_type -> batch_job.AdminRegistryBizRsp
	5,  // 34: batch_job.BatchJobService.AdminChangeBiz:output_type -> batch_job.AdminRegistryBizRsp
	13, // 35: batch_job.BatchJobService.AdminCreateJob:output_type -> batch_job.AdminCreateJobRsp
	15, // 36: batch_job.BatchJobService.AdminStartJob:output_type -> batch_job.AdminStartJobRsp
	17, // 37: batch_job.BatchJobService.AdminStopJob:output_type -> batch_job.AdminStopJobRsp
	19, // 38: batch_job.BatchJobService.QueryBizInfo:output_type -> batch_job.QueryBizInfoRsp
	21, // 39: batch_job.BatchJobService.QueryBizList:output_type -> batch_job.QueryBizListRsp
	23, // 40: batch_job.BatchJobService.QueryJobBaseInfo:output_type -> batch_job.QueryJobBaseInfoRsp
	25, // 41: batch_job.BatchJobService.QueryJobList:output_type -> batch_job.QueryJobListRsp
	27, // 42: batch_job.BatchJobService.QueryJobDataLog:output_type -> batch_job.QueryJobDataLogRsp
	29, // 43: batch_job.BatchJobService.BizStartJob:output_type -> batch_job.BizStartJobRsp
	31, // 44: batch_job.BatchJobService.BizStopJob:output_type -> batch_job.BizStopJobRsp
	33, // 45: batch_job.BatchJobService.BizUpdateBizData:output_type -> batch_job.BizUpdateBizDataRsp
	35, // 46: batch_job.BatchJobService.BizIncrProcessedNum:output_type -> batch_job.BizIncrProcessedNumRsp
	37, // 47: batch_job.BatchJobService.BizAddDataLog:output_type -> batch_job.BizAddDataLogRsp
