...
const file_batch_job_proto_rawDesc = "" +
	...
	"\x01v\x18\x02 \x01(\tR\x01v\"\xbb\x04\n" +
	...
	"\x05proxy\x18\v \x01(\tR\x05proxy\x12$\n" +
	"\rrspParseField\x18\f \x01(\tR\rrspParseField\"]\n" +
	"\x0fExecExtendDataA\x12J\n" +
	"\fhttpCallback\x18\x01 \x01(\v2&.batch_job.ExecExtendDataHttpCallbackAR\fhttpCallback\"\xe6\x03\n" +
	...
	" \x03(\v2\r.batch_job.KVR\aheaders\x12\x14\n" +
	"\x05proxy\x18\v \x01(\tR\x05proxy\x12$\n" +
	"\rrspParseField\x18\f \x01(\tR\rrspParseField\"\x97\x02\n" +
	...
	"createTime\x12/\n" +
	"\bconcType\x18\n" +
	" \x01(\x0e2\x13.batch_job.ConcTypeR\bconcType\x12\x18\n" +
	...
	"createTime\x18\b \x01(\x03R\n" +
	"createTime\x12/\n" +
	"\bconcType\x18\t \x01(\x0e2\x13.batch_job.ConcTypeR\bconcType\x12\x18\n" +
	"\arateSec\x18\n" +
	...
	"\bConcType\x12\x14\n" +
	"\x10ConcType_RateSec\x10\x00\x12\x1a\n" +
	"\x16ConcType_Serialization\x10\x01*8\n" +
	"\bExecType\x12\x11\n" +
